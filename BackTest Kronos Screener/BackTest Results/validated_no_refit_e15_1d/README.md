# Validated No-Refit E15 — 1D Full-Timeframe

Arsip hasil `validated_no_refit_e15_1d` yang dioptimalkan terhadap seluruh sesi
valid. Dibuat dari `validated_no_refit_e15_1d.zip` pada 1 Agustus 2026.
...
| Total hits | 584 |
| Overall win rate | 47.48% |
| Kronos gain baseline | 38.86% |
| Predicted hit-5 baseline | 40.89% |
| Optuna trials | 1,500 |
